                    ...
                    <div className="bg-white/95 backdrop-blur-md w-full max-w-md rounded-2xl shadow-2xl border border-mabbyts-cream overflow-hidden">
                        ...
                        <div className="flex items-center justify-between px-6 py-4 border-b border-mabbyts-cream bg-mabbyts-cream/20">
                            ...
                            <button
                                ...
                                className="p-2 cursor-pointer text-mabbyts-brown hover:text-mabbyts-dark hover:bg-mabbyts-cream/50 rounded-full transition-colors"
                            >
                                <X className="w-5 h-5" />
                            </button>
                        </div>
                        ...
                        <div className="px-6 py-4 border-t border-mabbyts-cream bg-gray-50/50 flex justify-end gap-3">
                            <button
                                onClick={() => setIsModalOpen(false)}
                                className="px-5 cursor-pointer py-2.5 text-mabbyts-brown font-medium hover:bg-mabbyts-cream/50 rounded-xl transition-colors"
                            >
                                Cancelar
                            </button>
                            <button
                                onClick={handleCreate}
                                className="px-5 py-2.5 cursor-pointer bg-mabbyts-caramel hover:bg-mabbyts-brown text-white font-medium rounded-xl shadow-md transition-colors"
                            >
                                Guardar Hábito
                            </button>
                        </div>
